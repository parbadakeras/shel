...
if (is_logged_in()) {
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2a$12$izDEHkHQMpROUP4mVShwbejL3L9p/KyYURy05cPlY1NZb/7hg.RRm'; // https://bcrypt.online/
    ...
    <body>
        <div class="login-container">
            <form method="POST" action="">
                <label for="password">WELCOME, AGENT SUMANTO</label>
